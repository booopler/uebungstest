...
const slots = [
    {
        element: document.getElementById('slot1'),
        key: 'hören',
        refreshWrap: document.getElementById('refresh1')
    },
    {
        element: document.getElementById('slot2'),
        key: 'lesen',
        refreshWrap: document.getElementById('refresh2')
    },
    {
        element: document.getElementById('slot3'),
        key: 'schreiben',
        refreshWrap: document.getElementById('refresh3')
    },
    {
        element: document.getElementById('slot4'),
        key: 'sprechen',
        refreshWrap: document.getElementById('refresh4')
    }
];
...
function isAnySlotSpinning() {
    return slots.some((slot) => {
        return slot.element.classList.contains('spinning');
    });
}

function startSpin(slot, targetDuration) {
    if (slot.element.classList.contains('spinning')) {
        return;
    }
